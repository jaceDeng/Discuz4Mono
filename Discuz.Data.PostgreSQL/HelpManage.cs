...
namespace Discuz.Data.PostgreSQL
{
    public partial class DataProvider : IDataProvider
    {
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Char, 100, title),
                                        DbHelper.MakeInParam("@message", (DbType)NpgsqlDbType.Text,0,message),
                                        DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer,4, pid),
                                        DbHelper.MakeInParam("@orderby", (DbType)NpgsqlDbType.Integer, 4, orderBy)                                        
                                    };
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@orderby", (DbType)NpgsqlDbType.Char, 100, orderBy),
                                        DbHelper.MakeInParam("@id", (DbType)NpgsqlDbType.Varchar, 100,id)
                                    };
