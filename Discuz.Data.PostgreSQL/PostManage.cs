    ...
    public partial class DataProvider : IDataProvider
    {
        ...
        public void AddBBCCode(int available, string tag, string icon, string replacement, string example, string explanation, string param, string nest, string paramsDescript, string paramsDefvalue)
        {
            DbParameter[] parms = 
			{
				...
				DbHelper.MakeInParam("@tag", (DbType)NpgsqlDbType.Varchar, 100, tag),
				DbHelper.MakeInParam("@icon", (DbType)NpgsqlDbType.Varchar,50, icon),
				DbHelper.MakeInParam("@replacement", (DbType)NpgsqlDbType.Text,0, replacement),
				DbHelper.MakeInParam("@example", (DbType)NpgsqlDbType.Varchar, 255, example),
				DbHelper.MakeInParam("@explanation", (DbType)NpgsqlDbType.Text, 0, explanation),
				DbHelper.MakeInParam("@params", (DbType)NpgsqlDbType.Integer, 4, param),
				DbHelper.MakeInParam("@nest", (DbType)NpgsqlDbType.Integer, 4, nest),
				DbHelper.MakeInParam("@paramsdescript", (DbType)NpgsqlDbType.Text, 0, paramsDescript),
				DbHelper.MakeInParam("@paramsdefvalue", (DbType)NpgsqlDbType.Text, 0, paramsDefvalue)
			};
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Uid),
                                        DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Tid),
                                        DbHelper.MakeInParam("@pid",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Pid),
                                        DbHelper.MakeInParam("@postdatetime",(DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(attachmentInfo.Postdatetime)),
                                        DbHelper.MakeInParam("@readperm",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Readperm),
                                        DbHelper.MakeInParam("@filename",(DbType)NpgsqlDbType.Varchar,100,attachmentInfo.Filename),
                                        DbHelper.MakeInParam("@description",(DbType)NpgsqlDbType.Varchar,100,attachmentInfo.Description),
                                        DbHelper.MakeInParam("@filetype",(DbType)NpgsqlDbType.Varchar,50,attachmentInfo.Filetype),
                                        DbHelper.MakeInParam("@filesize",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Filesize),
                                        DbHelper.MakeInParam("@attachment",(DbType)NpgsqlDbType.Varchar,255,attachmentInfo.Attachment),
                                        DbHelper.MakeInParam("@downloads",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Downloads),
                                        DbHelper.MakeInParam("@extname",(DbType)NpgsqlDbType.Varchar,50,Utils.GetFileExtName(attachmentInfo.Attachment)),
                                        DbHelper.MakeInParam("@attachprice",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Attachprice),
                                        DbHelper.MakeInParam("@width",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Width),
                                        DbHelper.MakeInParam("@height",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Height),
                                        DbHelper.MakeInParam("@isimage",(DbType)NpgsqlDbType.Smallint,1,attachmentInfo.Isimage)
							       };
        ...
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@aid",(DbType)NpgsqlDbType.Integer,4,aid)
                                  };
        ...
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@pid",(DbType)NpgsqlDbType.Integer,4,pid)
                                  };
        ...
        public IDataReader GetAttachmentListByTid(int tid)
        {
            return DbHelper.ExecuteReader(CommandType.StoredProcedure, string.Format("{0}getattachmentlistbytid", BaseConfigs.GetTablePrefix),
                                          DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Varchar, 500, tid));
        }
        ...
        {
            return DbHelper.ExecuteNonQuery(CommandType.Text, string.Format("DELETE FROM [{0}attachments] WHERE [aid]=@aid", BaseConfigs.GetTablePrefix),
                                            DbHelper.MakeInParam("@aid", (DbType)NpgsqlDbType.Integer, 4, aid));
        }
        ...
        {
            return DbHelper.ExecuteNonQuery(CommandType.Text, string.Format("DELETE FROM [{0}attachments] WHERE [pid]=@pid", BaseConfigs.GetTablePrefix), DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, pid));
        }
        ...
        {
            DbParameter[] parms = {
										DbHelper.MakeInParam("@aid",(DbType)NpgsqlDbType.Integer, 4,attachmentInfo.Aid),
										DbHelper.MakeInParam("@postdatetime",(DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(attachmentInfo.Postdatetime)),
										DbHelper.MakeInParam("@readperm", (DbType)NpgsqlDbType.Integer, 4, attachmentInfo.Readperm),
										DbHelper.MakeInParam("@filename", (DbType)NpgsqlDbType.Char, 100, attachmentInfo.Filename),
										DbHelper.MakeInParam("@description", (DbType)NpgsqlDbType.Char, 100, attachmentInfo.Description),
										DbHelper.MakeInParam("@filetype", (DbType)NpgsqlDbType.Char, 50, attachmentInfo.Filetype),
										DbHelper.MakeInParam("@filesize", (DbType)NpgsqlDbType.Integer, 4, attachmentInfo.Filesize),
										DbHelper.MakeInParam("@attachment", (DbType)NpgsqlDbType.Char, 255, attachmentInfo.Attachment),
										DbHelper.MakeInParam("@downloads", (DbType)NpgsqlDbType.Integer, 4, attachmentInfo.Downloads),
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, attachmentInfo.Tid),
                                        DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, attachmentInfo.Pid),
                                        DbHelper.MakeInParam("@attachprice",(DbType)NpgsqlDbType.Integer,4,attachmentInfo.Attachprice),
            ...
            return DbHelper.ExecuteNonQuery(CommandType.Text,
                                            string.Format("UPDATE [{0}attachments] SET [postdatetime] = @postdatetime, [readperm] = @readperm, [filename] = @filename, [description] = @description, [filetype] = @filetype, [filesize] = @filesize, [attachment] = @attachment, [downloads] = @downloads, [tid]=@tid, [pid]=@pid, [attachprice]=@attachprice, [width]=@width, [height]=@height,[isimage]=@isimage WHERE [aid]=@aid;UPDATE [{0}myattachments] SET [tid]=@tid,[pid]=@pid WHERE [aid]=@aid", BaseConfigs.GetTablePrefix),
                                            parms);
        }
        ...
        public IDataReader GetAttachmentList(string aidList)
        {
            return DbHelper.ExecuteReader(CommandType.Text,
                                          string.Format("SELECT [aid], [tid], [pid], [filename] FROM [{0}attachments] WITH (NOLOCK) WHERE [aid] IN ({1} )", BaseConfigs.GetTablePrefix, aidList));
        }

        public IDataReader GetAttachmentListByPid(string pidList)
        {
            return DbHelper.ExecuteReader(CommandType.Text,
                                          string.Format("SELECT [aid],[uid],[tid],[pid],[postdatetime],[readperm],[filename],[description],[filetype],[filesize],[attachment],[downloads],[attachprice],[width],[height],[isimage]FROM [{0}attachments] WITH (NOLOCK)WHERE [dnt_attachments].[pid] IN ({1} )", BaseConfigs.GetTablePrefix, pidList));
        }
        ...
        public int GetUploadFileSizeByUserId(int uid)
        {
            return TypeConverter.ObjectToInt(
                        DbHelper.ExecuteScalar(CommandType.Text,
                                               string.Format("SELECT SUM([filesize]) AS [todaysize] FROM [dnt_attachments] WHERE [uid]=@uid AND date_part('days',[postdatetime]-now())=0", BaseConfigs.GetTablePrefix),
                                               DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, uid)));
        }
        ...
        public void AddAttchType(string extension, string maxsize)
        {
            DbParameter[] parms = 
			{
				DbHelper.MakeInParam("@extension", (DbType)NpgsqlDbType.Varchar,256, extension),
				DbHelper.MakeInParam("@maxsize", (DbType)NpgsqlDbType.Integer, 4, maxsize)
			};
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@startDateTime", (DbType)NpgsqlDbType.Timestamp, 8, startDateTime),
                                        DbHelper.MakeInParam("@endDateTime", (DbType)NpgsqlDbType.Timestamp, 8, endDateTime)
            };
        ...
        public DataTable GetModeratorLogByPostDate(DateTime postDateTime)
        {
            ...
            return DbHelper.ExecuteDataset(CommandType.Text, commandText,
                                           DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp, 8, postDateTime)).Tables[0];
        }
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@fidlist", (DbType)NpgsqlDbType.Varchar, 255, fidList),
                                        DbHelper.MakeInParam("@displayorder", (DbType)NpgsqlDbType.Integer, 4, filter),
                                        DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer, 4, tpp),
        ...
        public int GetUnauditNewTopicCount(string fidList, int filter)
        {
            ...
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalarToStr(CommandType.Text, commandText, DbHelper.MakeInParam("@filter", (DbType)NpgsqlDbType.Integer, 4, filter)));
        }
        ...
        public IDataReader GetUnauditNewPost(string fidList, int ppp, int pageId, int tableId, int filter)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@fidlist", (DbType)NpgsqlDbType.Varchar, 255, fidList),
                                        DbHelper.MakeInParam("@tableid",(DbType)NpgsqlDbType.Integer,4,tableId),
                                        DbHelper.MakeInParam("@filter", (DbType)NpgsqlDbType.Integer, 4, filter),
                                        DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer, 4, ppp),
                                        DbHelper.MakeInParam("@pageindex", (DbType)NpgsqlDbType.Integer, 4, pageId),
                                  };
        ...
        public void PassAuditNewTopic(string tableId, string ignore, string validate, string delete, string fidList)
        {
            if (!Utils.StrIsNullOrEmpty(validate))
            {
                ...
                //        string.Format("UPDATE [{0}forums] SET [topics] = [topics] + 1, [curtopics] = [curtopics] + 1, [posts]=[posts] + 1, [todayposts]=CASE WHEN DATEPART(yyyy, [lastpost])=DATEPART(yyyy,NOW()) AND DATEPART(mm,[lastpost])=DATEPART(mm,NOW()) AND DATEPART(dd, [lastpost])=DATEPART(dd,NOW()) THEN [todayposts]*1 + 1	ELSE 1 END,[lasttid]={1} ,	[lasttitle]='{2}',[lastpost]='{3}',[lastposter]='{4}',[lastposterid]={5}  WHERE [fid]={6}",
                //                                             BaseConfigs.GetTablePrefix,
                //                                             dr["tid"],
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@fidlist", (DbType)NpgsqlDbType.Char, 500, fidList),
                                        DbHelper.MakeInParam("@tidlist", (DbType)NpgsqlDbType.Char, 500, tidList)
                                  };
        ...
        public void PassAuditNewTopic(string postTableName, string tidList)
        {
            ...
            DbHelper.ExecuteNonQuery(CommandType.Text, string.Format("UPDATE  [{0}]  SET [invisible]=0 WHERE [layer]=0  AND [tid] IN({1})",
                                                                      postTableName,
                                                                      tidList));
            DbHelper.ExecuteNonQuery(CommandType.Text, string.Format("UPDATE  [{0}topics]  SET [displayorder]=0,[lastpostid]=(SELECT   [pid] FROM [{2}] WHERE [tid]=[{0}topics].[tid] ORDER BY [pid] DESC) WHERE [tid] IN({1})  limit 1",
                                                                      BaseConfigs.GetTablePrefix,
        ...
        public void AuditPost(int tableId, string validate, string delete, string ignore, string fidList)
        {
            DbParameter[] parms = 
			{
				DbHelper.MakeInParam("@validate", (DbType)NpgsqlDbType.Varchar, 100, validate),
                DbHelper.MakeInParam("@ignore", (DbType)NpgsqlDbType.Varchar, 100, ignore),
                DbHelper.MakeInParam("@delete", (DbType)NpgsqlDbType.Varchar,100, delete)
            };
            if (!Utils.StrIsNullOrEmpty(validate))
            {
                //更新帖子显示状态为显示
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@fidlist", (DbType)NpgsqlDbType.Varchar, 500, fidList),
                                        DbHelper.MakeInParam("@postTableId",(DbType)NpgsqlDbType.Varchar, 5, postTableId),
                                        DbHelper.MakeInParam("@pidList", (DbType)NpgsqlDbType.Varchar, 500, pidList)
                                  };
        ...
        public void PassPost(int currentPostTableId, string pidList)
        {
            ...
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@currentPostTableId",(DbType)NpgsqlDbType.Integer,4,currentPostTableId),
        ...
        {
            string commandText = string.Format("SELECT  [layer],[tid]  FROM [{0}posts{1}] WHERE [pid]={2} limit 1",
                                        BaseConfigs.GetTablePrefix,
                                        currentPostTableId,
                                        postId);
            return DbHelper.ExecuteDataset(CommandType.Text, commandText).Tables[0];
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@starttime", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(startTime));
            ...
            string sqlstr = string.Format(@"SELECT  {1}, [f].[name], [ff].[rewritename] FROM [{2}topics] AS [t] LEFT JOIN [{2}forums] AS [f] ON [t].[fid] = [f].[fid] LEFT JOIN [{2}forumfields] ff ON [f].[fid] = [ff].[fid] WHERE [t].[closed]<>1 AND  [t].[displayorder] >=0 AND [t].[views] > {3} AND [t].[postdatetime] > @starttime{4}{5} AND [ff].[password] ='' ORDER BY [t].[{6}] DESC  LIMIT   {0}",
                                   count,
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@lastposter", (DbType)NpgsqlDbType.Varchar, 20, lastPoster),
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Integer, 4, posterId),
                                        DbHelper.MakeInParam("@poster", (DbType)NpgsqlDbType.Varchar, 20, poster)
                                    };
        ...
        public DataSet GetPosts(int tid, int pageSize, int pageIndex, string postTableId)
        {
            ...
            sb.Append(@"select  dnt_posts{0}.pid ,                        dnt_posts{0}.fid ,                        dnt_posts{0}.title ,                        dnt_posts{0}.layer ,                        dnt_posts{0}.message ,                        dnt_posts{0}.ip ,                        dnt_posts{0}.lastedit ,                        dnt_posts{0}.postdatetime ,                        dnt_posts{0}.attachment ,                        dnt_posts{0}.poster ,                        dnt_posts{0}.posterid ,                        dnt_posts{0}.invisible ,                        dnt_posts{0}.usesig ,                        dnt_posts{0}.htmlon ,                        dnt_posts{0}.smileyoff ,                        dnt_posts{0}.parseurloff ,                        dnt_posts{0}.bbcodeoff ,                        dnt_posts{0}.rate ,                        dnt_posts{0}.ratetimes ,                        dnt_users.nickname ,                        dnt_users.username ,                        dnt_users.groupid ,                        dnt_users.spaceid ,                        dnt_users.gender ,                        dnt_users.bday ,                        dnt_users.email ,                        dnt_users.showemail ,                        dnt_users.digestposts ,                        dnt_users.credits ,                        dnt_users.extcredits1 ,                        dnt_users.extcredits2 ,                        dnt_users.extcredits3 ,                        dnt_users.extcredits4 ,                        dnt_users.extcredits5 ,                        dnt_users.extcredits6 ,                        dnt_users.extcredits7 ,                        dnt_users.extcredits8 ,                        dnt_users.posts ,                        dnt_users.joindate ,                        dnt_users.onlinestate ,                        dnt_users.lastactivity ,                        dnt_users.oltime ,                        dnt_users.lastvisit ,                        dnt_users.invisible AS userinvisible ,                        dnt_userfields.avatar ,                        dnt_userfields.avatarwidth ,                        dnt_userfields.avatarheight ,                        dnt_userfields.medals ,                        dnt_userfields.sightml AS signature ,                        dnt_userfields.location ,                        dnt_userfields.customstatus ,                        dnt_userfields.website ,                        dnt_userfields.icq ,                        dnt_userfields.qq ,                        dnt_userfields.msn ,                        dnt_userfields.yahoo ,                        dnt_userfields.skype              FROM      dnt_posts{0}                        LEFT JOIN dnt_users ON dnt_users.uid = dnt_posts{0}.posterid                        LEFT JOIN dnt_userfields ON dnt_userfields.uid = dnt_users.uid              WHERE     tid = @tid                        AND dnt_posts{0}.invisible <= 0");
            ...
            return DbHelper.ExecuteDataset(CommandType.Text, string.Format(sb.ToString(), postTableId), parms);
        }
        ...
        public int InsertRateLog(int pid, int userId, string userName, int extId, float score, string reason)
        {
            DbParameter[] parms = {
				...
				DbHelper.MakeInParam("@extcredits", (DbType)NpgsqlDbType.Smallint, 1, extId),
				DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Now),
				DbHelper.MakeInParam("@score", (DbType)NpgsqlDbType.Smallint, 2, score),
				DbHelper.MakeInParam("@reason", (DbType)NpgsqlDbType.Varchar, 50, reason)
			};
        ...
        public int GetPostCount(int fid, string postTableName)
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@fid",(DbType)NpgsqlDbType.Integer,4,fid),
									   DbHelper.MakeInParam("@posttablename", (DbType)NpgsqlDbType.Varchar, 50, postTableName)
								   };
        ...
        public void ResetLastRepliesInfoOfTopics(int postTableID)
        {
            ...
            DbParameter parms = DbHelper.MakeInParam("@posttable", (DbType)NpgsqlDbType.Varchar, 20, postTableName);
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Char,100,tid),
									   DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Varchar, 20, posterId)
								   };
        ...
        {
            string commandText = string.Format("SELECT COUNT([pid]) AS [postcount] FROM [{0}] WHERE [fid] = {1} AND DATEDIFF(day, [postdatetime], NOW()) = 0",
                                                postTableName,
                                                fid);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text, commandText));
        }
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Char,100,uid),
									   DbHelper.MakeInParam("@posttablename", (DbType)NpgsqlDbType.Varchar, 20, postTableName)
								   };
        ...
        {
            DbParameter[] parms = {
				DbHelper.MakeInParam("@totaltopic", (DbType)NpgsqlDbType.Integer, 4, topicsCount),
				DbHelper.MakeInParam("@totalpost", (DbType)NpgsqlDbType.Integer, 4, postCount),
				DbHelper.MakeInParam("@totalusers", (DbType)NpgsqlDbType.Integer, 4, userCount),
				DbHelper.MakeInParam("@lastusername", (DbType)NpgsqlDbType.Varchar, 20, lastUserName),
				DbHelper.MakeInParam("@lastuserid", (DbType)NpgsqlDbType.Integer, 4, Utils.StrToInt(lastUserId, 0))
			};
        ...
        public void UpdateTopic(int tid, int postCount, int lastPostId, string lastPost, int lastPosterId, string poster)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                        DbHelper.MakeInParam("@postcount", (DbType)NpgsqlDbType.Integer, 4, postCount),
                                        DbHelper.MakeInParam("@lastpostid", (DbType)NpgsqlDbType.Integer, 4, lastPostId),
                                        DbHelper.MakeInParam("@lastpost", (DbType)NpgsqlDbType.Varchar, 20, lastPost),
                                        DbHelper.MakeInParam("@lastposterid", (DbType)NpgsqlDbType.Integer, 4, lastPosterId),
                                        DbHelper.MakeInParam("@lastposter", (DbType)NpgsqlDbType.Varchar, 20, poster)
                                    };
        ...
        {
            DbParameter[] parms = {
				DbHelper.MakeInParam("@start_tid", (DbType)NpgsqlDbType.Integer, 4, startTid),
				DbHelper.MakeInParam("@end_tid", (DbType)NpgsqlDbType.Integer, 4, endTid)
			};
        ...
        public IDataReader GetForumLastPost(int fid, string postTableName, int topicCount, int postCount, int lastTid, string lastTitle, string lastPost, int lastPosterId, string lastPoster, int todayPostCount)
        {
            DbParameter[] prams_posts = {
					DbHelper.MakeInParam("@lastfid", (DbType)NpgsqlDbType.Integer, 4, fid),
					DbHelper.MakeInParam("@topiccount", (DbType)NpgsqlDbType.Integer, 4, topicCount),
					DbHelper.MakeInParam("@postcount", (DbType)NpgsqlDbType.Integer, 4, postCount),
					DbHelper.MakeInParam("@lasttid", (DbType)NpgsqlDbType.Integer, 4, lastTid),
					DbHelper.MakeInParam("@lasttitle", (DbType)NpgsqlDbType.Char, 80, lastTitle),
					DbHelper.MakeInParam("@lastpost", (DbType)NpgsqlDbType.Varchar, 20, lastPost),
					DbHelper.MakeInParam("@lastposterid", (DbType)NpgsqlDbType.Integer, 4, lastPosterId),
					DbHelper.MakeInParam("@lastposter", (DbType)NpgsqlDbType.Char, 20, lastPoster),
					DbHelper.MakeInParam("@todaypostcount", (DbType)NpgsqlDbType.Integer, 4, todayPostCount)
                                            };
            string commandText = string.Format("SELECT   [tid], [title], [postdatetime], [posterid], [poster] FROM [{0}] WHERE [fid] = @lastfid OR [fid] IN (SELECT fid  FROM [{1}forums] WHERE CHARINDEX(',' + RTRIM(@lastfid) + ',', ',' + RTRIM(parentidlist) + ',') > 0) ORDER BY [pid] DESC limit 1",
                                                postTableName,
                                                BaseConfigs.GetTablePrefix);
        ...
        {
            DbParameter[] parms = {
				DbHelper.MakeInParam("@start_fid", (DbType)NpgsqlDbType.Integer, 4, startFid),
				DbHelper.MakeInParam("@end_fid", (DbType)NpgsqlDbType.Integer, 4, endFid)
			};
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,pollInfo.Tid),
									   DbHelper.MakeInParam("@displayorder",(DbType)NpgsqlDbType.Integer,4,pollInfo.Displayorder),
									   DbHelper.MakeInParam("@multiple",(DbType)NpgsqlDbType.Integer,4,pollInfo.Multiple),
									   DbHelper.MakeInParam("@visible",(DbType)NpgsqlDbType.Integer,4,pollInfo.Visible),
                                       DbHelper.MakeInParam("@allowview",(DbType)NpgsqlDbType.Integer,4,pollInfo.Allowview),
									   DbHelper.MakeInParam("@maxchoices",(DbType)NpgsqlDbType.Integer,4,pollInfo.Maxchoices),
									   DbHelper.MakeInParam("@expiration",(DbType)NpgsqlDbType.Timestamp,8,pollInfo.Expiration),
                                       DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,pollInfo.Uid),
                                       DbHelper.MakeInParam("@voternames",(DbType)NpgsqlDbType.Text,0,pollInfo.Voternames)
                                  };
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,pollOptionInfo.Tid),
									   DbHelper.MakeInParam("@pollid",(DbType)NpgsqlDbType.Integer,4,pollOptionInfo.Pollid),
									   DbHelper.MakeInParam("@votes",(DbType)NpgsqlDbType.Integer,4,pollOptionInfo.Votes),
									   DbHelper.MakeInParam("@displayorder",(DbType)NpgsqlDbType.Integer,4,pollOptionInfo.Displayorder),
									   DbHelper.MakeInParam("@polloption",(DbType)NpgsqlDbType.Varchar,80,pollOptionInfo.Polloption),
									   DbHelper.MakeInParam("@voternames",(DbType)NpgsqlDbType.Text,0,pollOptionInfo.Voternames)
								   };
        ...
        public bool UpdatePoll(PollInfo pollInfo)
        {
            DbParameter[] parms = {
                                       ...
                                       DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,pollInfo.Uid),
                                       DbHelper.MakeInParam("@voternames",(DbType)NpgsqlDbType.Text,0,pollInfo.Voternames),
                                       DbHelper.MakeInParam("@pollid",(DbType)NpgsqlDbType.Integer,4,pollInfo.Pollid),
                                  };
        ...
        public bool UpdatePollOption(PollOptionInfo pollOptionInfo)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@polloption",(DbType)NpgsqlDbType.Varchar,80,pollOptionInfo.Polloption),
									   DbHelper.MakeInParam("@voternames",(DbType)NpgsqlDbType.Text,0,pollOptionInfo.Voternames),
                                       DbHelper.MakeInParam("@polloptionid",(DbType)NpgsqlDbType.Integer,4,pollOptionInfo.Polloptionid)
								   };
        ...
        public string GetPollUserNameList(int tid)
        {
            ...
            string commandText = string.Format("SELECT   [voternames] FROM [{0}polls] WHERE [tid]=@tid  limit 1", BaseConfigs.GetTablePrefix);
        ...
        {
            string commandText = string.Format("SELECT   [multiple] FROM [{0}polls] WHERE [tid]={1} limit 1", BaseConfigs.GetTablePrefix, tid);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text, commandText));
        }
        ...
        {
            string commandText = string.Format("SELECT  [expiration] FROM [{0}polls] WHERE [tid]={1} limit 1",
                                                BaseConfigs.GetTablePrefix,
                                                tid);
        ...
        public int CreatePost(PostInfo postInfo, string postTableId)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@fid",(DbType)NpgsqlDbType.Smallint,2,postInfo.Fid),
									   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,postInfo.Tid),
									   DbHelper.MakeInParam("@parentid",(DbType)NpgsqlDbType.Integer,4,postInfo.Parentid),
									   DbHelper.MakeInParam("@layer",(DbType)NpgsqlDbType.Integer,4,postInfo.Layer),
									   DbHelper.MakeInParam("@poster",(DbType)NpgsqlDbType.Varchar,15,postInfo.Poster),
									   DbHelper.MakeInParam("@posterid",(DbType)NpgsqlDbType.Integer,4,postInfo.Posterid),
									   DbHelper.MakeInParam("@title",(DbType)NpgsqlDbType.Varchar,60,postInfo.Title),
									   DbHelper.MakeInParam("@topictitle",(DbType)NpgsqlDbType.Varchar,60,postInfo.Topictitle),
									   DbHelper.MakeInParam("@postdatetime",(DbType)NpgsqlDbType.Timestamp,8, DateTime.Parse(postInfo.Postdatetime)),
									   DbHelper.MakeInParam("@message",(DbType)NpgsqlDbType.Text,0,postInfo.Message),
									   DbHelper.MakeInParam("@ip",(DbType)NpgsqlDbType.Varchar,15,postInfo.Ip),
									   DbHelper.MakeInParam("@lastedit",(DbType)NpgsqlDbType.Varchar,50,postInfo.Lastedit),
									   DbHelper.MakeInParam("@invisible",(DbType)NpgsqlDbType.Integer,4,postInfo.Invisible),
									   DbHelper.MakeInParam("@usesig",(DbType)NpgsqlDbType.Integer,4,postInfo.Usesig),
									   DbHelper.MakeInParam("@htmlon",(DbType)NpgsqlDbType.Integer,4,postInfo.Htmlon),
									   DbHelper.MakeInParam("@smileyoff",(DbType)NpgsqlDbType.Integer,4,postInfo.Smileyoff),
									   DbHelper.MakeInParam("@bbcodeoff",(DbType)NpgsqlDbType.Integer,4,postInfo.Bbcodeoff),
									   DbHelper.MakeInParam("@parseurloff",(DbType)NpgsqlDbType.Integer,4,postInfo.Parseurloff),
									   DbHelper.MakeInParam("@attachment",(DbType)NpgsqlDbType.Integer,4,postInfo.Attachment),
									   DbHelper.MakeInParam("@rate",(DbType)NpgsqlDbType.Smallint,2,postInfo.Rate),
									   DbHelper.MakeInParam("@ratetimes",(DbType)NpgsqlDbType.Integer,4,postInfo.Ratetimes)
								   };
            StringBuilder sb = new StringBuilder();
            sb.Append(@"DELETE FROM dnt_postid WHERE Date_part('minute', postdatetime- now()) >5;
INSERT INTO dnt_postid (postdatetime) VALUES(now());");
            sb.Append("  INSERT INTO [dnt_posts{0}]([pid], [fid], [tid], [parentid], [layer], [poster], [posterid], [title], [postdatetime], [message], [ip], [lastedit], [invisible], [usesig], [htmlon], [smileyoff], [bbcodeoff], [parseurloff], [attachment], [rate], [ratetimes]) VALUES(currval('dnt_postid_pid_seq'), @fid, @tid, @parentid, @layer, @poster, @posterid, @title, @postdatetime, @message, @ip, @lastedit, @invisible, @usesig, @htmlon, @smileyoff, @bbcodeoff, @parseurloff, @attachment, @rate, @ratetimes); ");
            if (postInfo.Parentid == 0)
                sb.Append("UPDATE [dnt_posts{0}] SET [parentid]=currval('dnt_postid_pid_seq') WHERE [pid]=currval('dnt_postid_pid_seq');");

            if (postInfo.Invisible == 0)
            {
                sb.Append(" UPDATE [dnt_statistics] SET [totalpost]=[totalpost] + 1	;");
                string filelist = DbHelper.ExecuteScalar(CommandType.Text, "SELECT   COALESCE([parentidlist],'') FROM [dnt_forums] WHERE [fid] = @fid ;", DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Integer, 4, postInfo.Fid)).ToString().Trim();
                if (filelist.Trim().Length != 0)
                {   //SET @fidlist = RTRIM(@fidlist) + ',' + CAST(@fid AS VARCHAR(10))
                    filelist = filelist + ',' + postInfo.Fid.ToString();
                }
                else
                {
                    filelist = postInfo.Fid.ToString();
                }
                sb.Append(@" UPDATE [dnt_forums] SET 
						                                [posts]=[posts] + 1, 
						                                [todayposts]=CASE 
										                                WHEN Date_part('days', [lastpost]- NOW())=0 THEN [todayposts] + 1 
									                                 ELSE 1 
									                                 END,
						                                [lasttid]=@tid,	
						                                ...
						                                [lastposter]=@poster,
						                                [lastposterid]=currval('dnt_postid_pid_seq') 
                    							
				                                		WHERE fid IN ( " + filelist + ") ;");

                sb.Append(@"  UPDATE [dnt_users] SET
	                                [lastpost] = @postdatetime,
	                                [lastpostid] = currval('dnt_postid_pid_seq'),
	                                [lastposttitle] = @title,
	                                [posts] = [posts] + 1,
	                                [lastactivity] = now()
                                WHERE [uid] = currval('dnt_postid_pid_seq')  ;");
                ...
                if (postInfo.Layer <= 0)
                {
                    ...
                    sb.Append(@"UPDATE [dnt_topics] SET [replies]=0,[lastposter]=@poster,[lastpost]=@postdatetime,[lastposterid]=currval('dnt_postid_pid_seq') WHERE [tid]=@tid ;");
                }
                else
                {
                    sb.Append("UPDATE [dnt_topics] SET [replies]=[replies] + 1,[lastposter]=@poster,[lastpost]=@postdatetime,[lastposterid]=currval('dnt_postid_pid_seq') WHERE [tid]=@tid ;");
                }

                sb.Append("UPDATE [dnt_topics] SET [lastpostid]=currval('dnt_postid_pid_seq') WHERE [tid]=@tid ;");

            }
            else if (postInfo.Layer <= 0)
            {
                sb.Append("UPDATE [dnt_topics] SET [replies]=0,[lastposter]=@poster,[lastpost]=@postdatetime,[lastposterid]=@posterid,[lastpostid]=currval('dnt_postid_pid_seq') WHERE [tid]=@tid					");
            }

            sb.Append(@"  INSERT INTO  [dnt_myposts]([uid], [tid], [pid], [dateline]) VALUES(@posterid, @tid, currval('dnt_postid_pid_seq'), @postdatetime) ;select currval('dnt_postid_pid_seq');               ");
            int pid = TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text,
                                                                 string.Format(sb.ToString(), postTableId),
                                                                    parms), -1);
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@pid",(DbType)NpgsqlDbType.Integer,4,postsInfo.Pid),
									   DbHelper.MakeInParam("@title",(DbType)NpgsqlDbType.Varchar,160,postsInfo.Title),
									   DbHelper.MakeInParam("@message",(DbType)NpgsqlDbType.Text,0,postsInfo.Message),
									   DbHelper.MakeInParam("@lastedit",(DbType)NpgsqlDbType.Varchar,50,postsInfo.Lastedit),
									   DbHelper.MakeInParam("@invisible",(DbType)NpgsqlDbType.Integer,4,postsInfo.Invisible),
									   DbHelper.MakeInParam("@usesig",(DbType)NpgsqlDbType.Integer,4,postsInfo.Usesig),
									   DbHelper.MakeInParam("@htmlon",(DbType)NpgsqlDbType.Integer,4,postsInfo.Htmlon),
									   DbHelper.MakeInParam("@smileyoff",(DbType)NpgsqlDbType.Integer,4,postsInfo.Smileyoff),
									   DbHelper.MakeInParam("@bbcodeoff",(DbType)NpgsqlDbType.Integer,4,postsInfo.Bbcodeoff),
									   DbHelper.MakeInParam("@parseurloff",(DbType)NpgsqlDbType.Integer,4,postsInfo.Parseurloff),
								   };
            return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure,
        ...
        public int DeletePost(string postTableId, int pid, bool changePosts)
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@pid",(DbType)NpgsqlDbType.Integer,4,pid),
                                       DbHelper.MakeInParam("@chanageposts",(DbType)NpgsqlDbType.Bit,1,changePosts)
								   };
            return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure,
        ...
        {
            string commandText = string.Format("SELECT   {0} FROM [{1}posts{2}] WHERE [pid]={3} limit 1",
                                                DbFields.POSTS,
                                                BaseConfigs.GetTablePrefix,
                                                postTableId,
                                                pid);
        ...
        public IDataReader GetPostListByCondition(PostpramsInfo postPramsInfo, string postTableId)
        {
            ...
            DbParameter[] parms = {
										   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,postPramsInfo.Tid),
										   DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer,4,postPramsInfo.Pagesize),
										   DbHelper.MakeInParam("@pageindex",(DbType)NpgsqlDbType.Integer,4,postPramsInfo.Pageindex),
                                           DbHelper.MakeInParam("@posterid",(DbType)NpgsqlDbType.Integer,4,posterid)
									   };
        ...
        {
            DbParameter[] parms = {
										   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Tid),
										   DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer,4,postParmsInfo.Pagesize),
										   DbHelper.MakeInParam("@pageindex",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Pageindex)
									   };
            ...
            sb.Append(" limit ");
            sb.Append(postParmsInfo.Pagesize);
            sb.Append(" offset ");
            sb.Append((postParmsInfo.Pageindex - 1) * postParmsInfo.Pagesize);
            if (((mcci != null && mcci.ApplyMemCached) || (rci != null && rci.ApplyRedis)) && postParmsInfo.Pageindex <= 5)
            {
                return DbHelper.ExecuteReaderInMasterDB(CommandType.Text,
                                          string.Format(sb.ToString(), postTableId),
                                          parms);
            }
            else
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid);
        ...
        public DataTable GetLastPostList(PostpramsInfo postParmsInfo, string postTableId)
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Tid),
                                       DbHelper.MakeInParam("@pageindex",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Pageindex),
									   DbHelper.MakeInParam("@postnum",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Pagesize)
								   };
        ...
        {
            DbParameter[] parms = {
										DbHelper.MakeInParam("@pid",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Pid),
										DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,postParmsInfo.Tid)
									};
            attachments = null;
            return DbHelper.ExecuteReader(CommandType.StoredProcedure,
        ...
        public IDataReader GetSinglePost(int tid, string postTableId)
        {
            string commandText = string.Format("SELECT {0} FROM [{1}posts{2}] WHERE [tid]=@tid AND [layer]=0",
                                                ...
                                                BaseConfigs.GetTablePrefix,
                                                postTableId);
            return DbHelper.ExecuteReader(CommandType.Text, commandText, DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid));
        }
        ...
        public DataTable GetPostTree(int tid, string postTableId)
        {
            return DbHelper.ExecuteDataset(CommandType.StoredProcedure, string.Format("{0}getpost{1}tree", BaseConfigs.GetTablePrefix, postTableId),
                                                            DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid)).Tables[0];
        }
        ...
        public int GetFirstPostId(int tid, string postTableId)
        {
            return TypeConverter.ObjectToInt(
                                 DbHelper.ExecuteScalar(CommandType.StoredProcedure,
                                                        ...
                                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid)), -1);
        }
        ...
        public IDataReader GetPostRateLogs(int pid, int displayRateCount)
        {
            string commandText = string.Format("SELECT TOP {0} {1} FROM [{2}ratelog] WHERE [pid]=@pid ORDER BY [id] DESC",
                                                ...
                                                DbFields.RATE_LOG,
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteReader(CommandType.Text, commandText, DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, pid));
        }
        ...
        {
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.StoredProcedure, string.Format("{0}getratecount", BaseConfigs.GetTablePrefix), DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, pid)));
        }
        ...
        public void DeleteExpriedSearchCache()
        {
            DbHelper.ExecuteNonQuery(CommandType.Text,
                                     ...
                                     DbHelper.MakeInParam("@expiration", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Now.AddMinutes(-30).ToString("yyyy-MM-dd HH:mm:ss")));
        }
        ...
        public DataTable GetSearchCache(int searchId)
        {
            return DbHelper.ExecuteDataset(CommandType.Text,
                                           ...
                                           DbHelper.MakeInParam("@searchid", (DbType)NpgsqlDbType.Integer, 4, searchId)).Tables[0];
        }
        ...
        public int SetTopicStatus(string topicList, string field, string intValue)
        {
            string commandText = string.Format("UPDATE [{0}topics] SET [{1}] = @field WHERE [tid] IN ({2})",
                                                ...
                                                topicList);
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText,
                                            DbHelper.MakeInParam("@field", (DbType)NpgsqlDbType.Varchar, 500, intValue));
        }
        ...
        {
            string commandText = string.Format("SELECT [posterid] FROM [{0}topics] WHERE EXTRACT(day, NOW()-[postdatetime])<@Losslessdel AND [tid] IN ({1})",
                                                BaseConfigs.GetTablePrefix,
                                                topicList);
            return DbHelper.ExecuteReader(CommandType.Text, commandText,
                                          DbHelper.MakeInParam("@Losslessdel", (DbType)NpgsqlDbType.Integer, 4, lossLessDel));
        }
        ...
        public int SetTopicClose(string topicList, short intValue)
        {
            string commandText = string.Format("UPDATE [{0}topics] SET [closed] = @field WHERE [tid] IN ({1}) AND [closed] IN (0,1)",
                                                ...
                                                topicList);
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText,
                                            DbHelper.MakeInParam("@field", (DbType)NpgsqlDbType.Smallint, 1, intValue));
        }
        ...
        {
            string commandText = string.Format("SELECT SUM(COALESCE([{0}],0)) AS [fieldcount] FROM [{1}topics] WHERE [tid] IN ({2})",
                                                field,
                                                BaseConfigs.GetTablePrefix,
                                                topicList);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteDataset(CommandType.Text, commandText).Tables[0].Rows[0][0]);
        ...
        {
            DbParameter[] parms = {
					DbHelper.MakeInParam("@tidlist", (DbType)NpgsqlDbType.Varchar, 2000, topicList),
                    DbHelper.MakeInParam("@chanageposts",(DbType)NpgsqlDbType.Bit,1,changePosts)
				};
            ...
            if (topicList != "")
            {
                ...
                IDataReader ddr = DbHelper.ExecuteReader(CommandType.Text, sqlstr);
                while (ddr.Read())
                {
                    ...
                    if (("," + tempFid.ToString() + ",").IndexOf(fid + ",") == 0)
                    {
                        ...
                        tempfidlist = DbHelper.ExecuteScalar(CommandType.Text, "select COALESCE([parentidlist],'') FROM [" + BaseConfigs.GetTablePrefix + "forums] WHERE [fid] = " + tempFid + "", parms).ToString();
                        //if (tempfidlist == null)
                        //{
                        //    tempfidlist = "";
            ...
            if (fid.Length > 0)
            {
                ...
                DbHelper.ExecuteNonQuery(CommandType.Text, sqlstr, parms);

                DbHelper.ExecuteNonQuery(CommandType.Text, "DELETE FROM [" + BaseConfigs.GetTablePrefix + "favorites] WHERE [tid] IN (" + topicList + ")", parms);

                DbHelper.ExecuteNonQuery(CommandType.Text, "DELETE FROM [" + BaseConfigs.GetTablePrefix + "polls] WHERE [tid] IN (" + topicList + ")", parms);
                DbHelper.ExecuteNonQuery(CommandType.Text, "DELETE FROM [" + BaseConfigs.GetTablePrefix + "posts1] WHERE [tid] IN (" + topicList + ")", parms);
                DbHelper.ExecuteNonQuery(CommandType.Text, "DELETE FROM [" + BaseConfigs.GetTablePrefix + "mytopics] WHERE [tid] IN (" + topicList + ")", parms);
            }

            DbHelper.ExecuteNonQuery(CommandType.Text, "DELETE FROM [" + BaseConfigs.GetTablePrefix + "topics] WHERE [closed] IN (" + topicList + ") OR [tid] IN (" + topicList + ")", parms);
        ...
        public int CopyTopicLink(int oldFid, string topicList)
        {
            ...
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText,
                                            DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Smallint, 2, oldFid));
        }
        ...
        public void UpdatePost(string topicList, int fid, string postTable)
        {
            string commandText = string.Format("UPDATE [{0}] SET [fid]=@fid WHERE [tid] IN ({1})",
                                                ...
                                                topicList);
            DbHelper.ExecuteNonQuery(CommandType.Text, commandText,
                                     DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Integer, 1, fid));
        }
        /// <summary>
        /// 更新主题所属版块,会将主题分类至为0
        /// </summary>
        ...
        public int UpdateTopic(string topicList, int fid, int topicType)
        {
            DbParameter[] parms =
					{
						DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Smallint, 1, fid),
                        DbHelper.MakeInParam("@typeid", (DbType)NpgsqlDbType.Smallint, 1, topicType)
					};
        ...
        public void SetPrimaryPost(string subject, int tid, string[] postIdArray, string postTableId)
        {
            DbParameter[] prams =
					{
						DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, Utils.StrToInt(postIdArray[0], 0)),
						DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Varchar, 80, subject)
					};
        ...
        public int UpdatePostTidToAnotherTopic(int oldTid, int newTid, string postTableId)
        {
            DbParameter[] prams =
				{
					DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, newTid),
					DbHelper.MakeInParam("@oldtid", (DbType)NpgsqlDbType.Integer, 4, oldTid)
				};
        ...
        {
            string commandText = string.Format("SELECT  [postdatetime],[pid],[poster],[posterid]  FROM [{0}] WHERE  [tid]={1}  ORDER BY [{0}].[pid] DESC  LIMIT 1",
                                                postTable,
                                                topicId);
        ...
        public string CheckRateState(int userId, string pid)
        {
            DbParameter[] parms =
					{
						DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, Utils.StrToFloat(pid, 0)),
						DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, userId)
					};
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@typeid", (DbType)NpgsqlDbType.Smallint, 1, topicTypeId),
									   DbHelper.MakeInParam("@topiclist", (DbType)NpgsqlDbType.Varchar, 250, topicList)
								   };
        ...
        {
            DbParameter[] parms = {
										DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Fid), 
										DbHelper.MakeInParam("@iconid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Iconid), 
										DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Char, 60, topicInfo.Title), 
										DbHelper.MakeInParam("@typeid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Typeid), 
										DbHelper.MakeInParam("@readperm", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Readperm), 
										DbHelper.MakeInParam("@price", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Price), 
										DbHelper.MakeInParam("@poster", (DbType)NpgsqlDbType.Char, 15, topicInfo.Poster), 
										DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Posterid), 
										DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp,8, DateTime.Parse(topicInfo.Postdatetime)), 
										DbHelper.MakeInParam("@lastpost", (DbType)NpgsqlDbType.Timestamp, 0, DateTime.Parse(topicInfo.Lastpost)), 
										DbHelper.MakeInParam("@lastpostid", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Lastpostid),
										DbHelper.MakeInParam("@lastposter", (DbType)NpgsqlDbType.Char, 15, topicInfo.Lastposter), 
										DbHelper.MakeInParam("@views", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Views), 
										DbHelper.MakeInParam("@replies", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Replies), 
										DbHelper.MakeInParam("@displayorder", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Displayorder), 
										DbHelper.MakeInParam("@highlight", (DbType)NpgsqlDbType.Varchar, 500, topicInfo.Highlight), 
										DbHelper.MakeInParam("@digest", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Digest), 
										DbHelper.MakeInParam("@rate", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Rate), 
										DbHelper.MakeInParam("@hide", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Hide), 
										DbHelper.MakeInParam("@attachment", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Attachment), 
										DbHelper.MakeInParam("@moderated", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Moderated), 
										DbHelper.MakeInParam("@closed", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Closed),
										DbHelper.MakeInParam("@magic", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Magic),
                                        DbHelper.MakeInParam("@special", (DbType)NpgsqlDbType.Smallint, 1, topicInfo.Special),
                                        DbHelper.MakeInParam("@attention", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Attention)
								   };
            StringBuilder sb = new StringBuilder();
            sb.Append(@"DELETE FROM [dnt_topics] WHERE [tid]>(SELECT COALESCE(max(tid),0)-100 FROM [dnt_topics]) AND [lastpostid]=0;
...
select  currval('dnt_topics_tid_seq');  ");

            int tid = TypeConverter.ObjectToInt(DbHelper.ExecuteDataset(CommandType.Text,
                                                                    sb.ToString(),
                                                                     parms).Tables[0].Rows[0][0], -1);
            sb = new StringBuilder();
            sb.Append(@"UPDATE [dnt_statistics] SET [totaltopic]=[totaltopic] + 1;
		UPDATE [dnt_forums] SET [topics] = [topics] + 1,[curtopics] = [curtopics] + 1 WHERE [fid] = @fid;");
            if (topicInfo.Posterid != -1)
            {
                sb.Append("INSERT INTO [dnt_mytopics]([tid],[uid],[dateline]) VALUES(@topicid,  @posterid,  @postdatetime) ;");
            }
            parms = new DbParameter[]{
        DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Fid),
            DbHelper.MakeInParam("@topicid", (DbType)NpgsqlDbType.Integer,0, tid),
            DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Integer,0, topicInfo.Posterid),
            DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp,0, DateTime.Parse( topicInfo.Postdatetime))
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@topics", (DbType)NpgsqlDbType.Integer, 4, topics),
									   DbHelper.MakeInParam("@fpidlist", (DbType)NpgsqlDbType.Varchar, 100, fpIdList)                                      
			};
            DbHelper.ExecuteNonQuery(CommandType.Text, string.Format(" UPDATE [dnt_forums] SET [topics] = [topics] +" + topics.ToString() + " WHERE [fid] IN (  {0})", fpIdList.Split(',')));
        }
        ...
        public IDataReader GetTopicInfo(int tid, int fid, byte mode)
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Integer, 4, fid),
									   DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                       DbHelper.MakeInParam("@mode", (DbType)NpgsqlDbType.Integer, 4, mode)
			};
            StringBuilder sb = new StringBuilder();
            if (mode == 1)
            {
                sb.Append("SELECT   [tid]      ,[fid]      ,[iconid]      ,[readperm]      ,[price]      ,[poster]      ,[posterid]      ,[title]      ,[postdatetime]      ,[lastpost]      ,[lastpostid]      ,[lastposter]      ,[lastposterid]      ,[views]      ,[replies]      ,[displayorder]      ,[highlight]      ,[digest]      ,[hide]      ,[attachment]      ,[moderated]      ,[closed]      ,[magic]      ,[identify]      ,[special]      ,[typeid]      ,[rate]      ,[attention] FROM [dnt_topics] WITH (NOLOCK) WHERE [fid]=@fid AND [lastpostid]>(SELECT [lastpostid] FROM [dnt_topics] WHERE [tid]=@tid) AND [displayorder]>=0  ORDER BY [lastpostid] ASC  LIMIT 1");
            }
            else if (mode == 2)
            {
                sb.Append(" SELECT   [tid]      ,[fid]      ,[iconid]      ,[readperm]      ,[price]      ,[poster]      ,[posterid]      ,[title]      ,[postdatetime]      ,[lastpost]      ,[lastpostid]      ,[lastposter]      ,[lastposterid]      ,[views]      ,[replies]      ,[displayorder]      ,[highlight]      ,[digest]      ,[hide]      ,[attachment]      ,[moderated]      ,[closed]      ,[magic]      ,[identify]      ,[special]      ,[typeid]      ,[rate]      ,[attention] FROM [dnt_topics]   WHERE [fid]=@fid AND [lastpostid]<(SELECT [lastpostid] FROM [dnt_topics] WHERE [tid]=@tid) AND [displayorder]>=0  ORDER BY [lastpostid] DESC  LIMIT 1");

            }
            else
            {
                sb.Append("  SELECT   [tid]      ,[fid]      ,[iconid]      ,[readperm]      ,[price]      ,[poster]      ,[posterid]      ,[title]      ,[postdatetime]      ,[lastpost]      ,[lastpostid]      ,[lastposter]      ,[lastposterid]      ,[views]      ,[replies]      ,[displayorder]      ,[highlight]      ,[digest]      ,[hide]      ,[attachment]      ,[moderated]      ,[closed]      ,[magic]      ,[identify]      ,[special]      ,[typeid]      ,[rate]      ,[attention] FROM [dnt_topics]   WHERE [tid]=@tid  LIMIT 1");
            }

            return DbHelper.ExecuteReader(CommandType.Text, sb.ToString(), parms);
        }
        ...
        public IDataReader GetTopTopics(int fid, int pageSize, int pageIndex, string tids)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer,4,pageSize),
									   DbHelper.MakeInParam("@pageindex",(DbType)NpgsqlDbType.Integer,4,pageIndex),
									   DbHelper.MakeInParam("@tids",(DbType)NpgsqlDbType.Varchar,500,tids)									   
								   };
        ...
        public IDataReader GetTopics(int fid, int pageSize, int pageIndex, int startNum, string condition)
        {
            if (condition.Trim() == string.Empty)
            {
                DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer,4,pageSize),
									   DbHelper.MakeInParam("@pageindex", (DbType)NpgsqlDbType.Integer,4,pageIndex),
                                       DbHelper.MakeInParam("@startnum",(DbType)NpgsqlDbType.Integer,4,startNum)
								   };
                return DbHelper.ExecuteReader(CommandType.StoredProcedure,
            ...
            else
            {
                DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer,4,pageSize),
									   DbHelper.MakeInParam("@pageindex", (DbType)NpgsqlDbType.Integer,4,pageIndex),
									   DbHelper.MakeInParam("@condition", (DbType)NpgsqlDbType.Varchar,80,condition),
								       DbHelper.MakeInParam("@startnum", (DbType)NpgsqlDbType.Varchar,80,startNum)
								   };
                return DbHelper.ExecuteReader(CommandType.StoredProcedure,
        ...
        public IDataReader GetTopicsByDate(int fid, int pageSize, int pageIndex, int startNumber, string condition, string orderFields, int sortType)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer,4,pageSize),
									   DbHelper.MakeInParam("@pageindex",(DbType)NpgsqlDbType.Integer,4,pageIndex),
									   DbHelper.MakeInParam("@startnum",(DbType)NpgsqlDbType.Integer,4,startNumber),
									   DbHelper.MakeInParam("@condition",(DbType)NpgsqlDbType.Varchar,80,condition),
									   DbHelper.MakeInParam("@orderby",(DbType)NpgsqlDbType.Varchar,80,orderFields),
									   DbHelper.MakeInParam("@ascdesc",(DbType)NpgsqlDbType.Integer,4,sortType)				                    
								   };
        ...
        public IDataReader GetTopicsByType(int pageSize, int pageIndex, int startNum, string condition, int ascDesc)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@pageindex",(DbType)NpgsqlDbType.Integer,4,pageIndex),
									   DbHelper.MakeInParam("@startnum",(DbType)NpgsqlDbType.Integer,4,startNum),
									   DbHelper.MakeInParam("@condition",(DbType)NpgsqlDbType.Varchar,1000,condition),
			                           DbHelper.MakeInParam("@ascdesc", (DbType)NpgsqlDbType.Integer, 4, ascDesc)
								   };
        ...
        public IDataReader GetTopicsByTypeDate(int pageSize, int pageIndex, int startNum, string condition, string orderBy, int ascDesc)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@startnum",(DbType)NpgsqlDbType.Integer,4,startNum),
									   DbHelper.MakeInParam("@condition",(DbType)NpgsqlDbType.Varchar,1000,condition),
									   DbHelper.MakeInParam("@orderby",(DbType)NpgsqlDbType.Varchar,80,orderBy),
									   DbHelper.MakeInParam("@ascdesc",(DbType)NpgsqlDbType.Integer,4,ascDesc)				                    
								   };
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Integer, 4, fid);
            return TypeConverter.ObjectToInt(
                                 DbHelper.ExecuteScalar(CommandType.Text,
                                                        string.Format("SELECT [curtopics] FROM [{0}forums] WHERE [fid] = @fid", BaseConfigs.GetTablePrefix),
                                                        param));
        }
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@subfidList", (DbType)NpgsqlDbType.Char, 400, subfidList);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.StoredProcedure,
        ...
        public int GetTopicCount(int fid, int state, string condition)
        {
            if (condition.Trim() == string.Empty)
            {
                ...
                return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text,
                                                                         string.Format("SELECT [curtopics] FROM [{0}forums] WHERE [fid] = @fid", BaseConfigs.GetTablePrefix),
                                                                         parms), -1);
            }
            else
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@condition", (DbType)NpgsqlDbType.Varchar, 4000, condition);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.StoredProcedure,
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4, topicInfo.Tid),
									   DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Fid), 
									   DbHelper.MakeInParam("@iconid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Iconid), 
									   DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Char, 60, topicInfo.Title), 
									   DbHelper.MakeInParam("@typeid", (DbType)NpgsqlDbType.Smallint, 2, topicInfo.Typeid), 
									   ...
									   DbHelper.MakeInParam("@poster", (DbType)NpgsqlDbType.Char, 15, topicInfo.Poster), 
									   DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Posterid), 
									   DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp, 4, DateTime.Parse(topicInfo.Postdatetime)), 
									   DbHelper.MakeInParam("@lastpost", (DbType)NpgsqlDbType.Timestamp, 0, topicInfo.Lastpost), 
                                       DbHelper.MakeInParam("@lastpostid", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Lastpostid), 
									   DbHelper.MakeInParam("@lastposter", (DbType)NpgsqlDbType.Char, 15, topicInfo.Lastposter), 
									   DbHelper.MakeInParam("@replies", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Replies), 
									   DbHelper.MakeInParam("@displayorder", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Displayorder), 
									   ...
									   DbHelper.MakeInParam("@rate", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Rate), 
									   DbHelper.MakeInParam("@hide", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Hide), 
									   DbHelper.MakeInParam("@special", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Special), 
									   DbHelper.MakeInParam("@attachment", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Attachment), 
									   DbHelper.MakeInParam("@moderated", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Moderated), 
									   DbHelper.MakeInParam("@closed", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Closed),
									   DbHelper.MakeInParam("@magic", (DbType)NpgsqlDbType.Integer, 4, topicInfo.Magic),
        ...
        public int UpdateTopicViewCount(int tid, int viewCount)
        {
            DbParameter[] parms = {
										DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,tid),	
										DbHelper.MakeInParam("@viewcount",(DbType)NpgsqlDbType.Integer,4,viewCount)			   
									};
            StringBuilder sb = new StringBuilder();
            sb.Append("UPDATE [dnt_topics]  SET [views]= [views] +" + viewCount + " WHERE [tid]=@tid");
            return DbHelper.ExecuteNonQuery(CommandType.Text, sb.ToString(), parms);
        }
                                        ...
                                        string repliesMax, string repliesMin, string rate, string lastPost, DateTime postDateTimeStart, DateTime postDateTimeEnd)
        {
            ...
            if (lastPost != "")
                commandText.AppendFormat(" AND DATEDIFF(day,[lastpost],NOW())>={0}", lastPost);
        ...
        public string SearchAttachment(int forumId, string postTableName, string fileSizeMin, string fileSizeMax, string downLoadsMin, string downLoadsMax, string postDateTime, string fileName, string description, string poster)
        {
            ...
            if (postDateTime != "")
                commandText.AppendFormat(" AND DATEDIFF(day,[postdatetime],NOW())>={0}", postDateTime);
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@identify", (DbType)NpgsqlDbType.Integer, 4, identify)
            };
        ...
        {
            string commandText = string.Format("SELECT   {0} FROM [{1}posts{2}] WHERE [pid] NOT IN ({3}) AND [tid]={4} ORDER BY [pid] DESC  limit 1",
                                                DbFields.POSTS,
                                                BaseConfigs.GetTablePrefix,
                                                postId,
                                                postIdList,
        ...
        public void CreateTopicTags(string tags, int topicId, int userId, string curDateTime)
        {
            DbParameter[] parms = {
                ...
                DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, topicId),
                DbHelper.MakeInParam("@userid", (DbType)NpgsqlDbType.Integer, 4, userId),
                DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp, 8, curDateTime)                
            };
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, topicId);
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, topicId);
        ...
        public void AddBonusLog(int tid, int authorId, int winerId, string winnerName, int postId, int bonus, int extId, int isBest)
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                    DbHelper.MakeInParam("@authorid", (DbType)NpgsqlDbType.Integer, 4, authorId),
                                    DbHelper.MakeInParam("@winerid", (DbType)NpgsqlDbType.Integer, 4, winerId),
                                    DbHelper.MakeInParam("@winnername", (DbType)NpgsqlDbType.Char, 20, winnerName),
                                    DbHelper.MakeInParam("@postid", (DbType)NpgsqlDbType.Integer, 4, postId),
                                    DbHelper.MakeInParam("@dateline", (DbType)NpgsqlDbType.Timestamp, 4, DateTime.Now),
                                    DbHelper.MakeInParam("@bonus", (DbType)NpgsqlDbType.Integer, 4, bonus),
                                    DbHelper.MakeInParam("@extid", (DbType)NpgsqlDbType.Smallint, 1, extId),
                                    DbHelper.MakeInParam("@isbest", (DbType)NpgsqlDbType.Integer, 4, isBest)
                                  };
        ...
        {
            DbParameter[] parms = {
                                      DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, debateTopic.Tid),
                                      DbHelper.MakeInParam("@positiveopinion", (DbType)NpgsqlDbType.Varchar, 200, debateTopic.Positiveopinion),
                                      DbHelper.MakeInParam("@negativeopinion", (DbType)NpgsqlDbType.Varchar, 200, debateTopic.Negativeopinion),
                                      DbHelper.MakeInParam("@terminaltime", (DbType)NpgsqlDbType.Timestamp, 8, debateTopic.Terminaltime)                                
                                  };
        ...
        {
            DbParameter[] parms = {
                                      DbHelper.MakeInParam("@tid",(DbType)NpgsqlDbType.Integer,4,debateInfo.Tid),
                                      DbHelper.MakeInParam("@positiveopinion",(DbType)NpgsqlDbType.Varchar,200,debateInfo.Positiveopinion),
                                      DbHelper.MakeInParam("@positivediggs",(DbType)NpgsqlDbType.Integer,4,debateInfo.Positivediggs),
                                      DbHelper.MakeInParam("@negativeopinion",(DbType)NpgsqlDbType.Varchar,200,debateInfo.Negativeopinion),
                                      DbHelper.MakeInParam("@negativediggs",(DbType)NpgsqlDbType.Integer,4,debateInfo.Negativediggs),
                                      DbHelper.MakeInParam("@terminaltime",(DbType)NpgsqlDbType.Timestamp,8,debateInfo.Terminaltime)
                                  };
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, dpei.Tid),
                                        DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, dpei.Pid),
                                        DbHelper.MakeInParam("@opinion", (DbType)NpgsqlDbType.Integer, 4, dpei.Opinion), 
                                        DbHelper.MakeInParam("@diggs", (DbType)NpgsqlDbType.Integer, 4, dpei.Diggs)
                                  };
        ...
        public void AddCommentDabetas(int tid, int tableId, string commentMsg)
        {
            ...
            DbParameter[] parms = {
                                       DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
									   DbHelper.MakeInParam("@message",(DbType)NpgsqlDbType.Text, 0, commandText + commentMsg)                                        
                                  };
        ...
        public void AddDebateDigg(int tid, int pid, int field, string ip, UserInfo userInfo)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                        DbHelper.MakeInParam("@pid", (DbType)NpgsqlDbType.Integer, 4, pid),
                                        DbHelper.MakeInParam("@debates", (DbType)NpgsqlDbType.Integer,4, field),
                                        DbHelper.MakeInParam("@diggerip",(DbType)NpgsqlDbType.Varchar,15,ip),
                	                    DbHelper.MakeInParam("@diggdatetime", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Now),
                                        DbHelper.MakeInParam("@diggerid", (DbType)NpgsqlDbType.Integer, 4,userInfo.Uid),
                                        DbHelper.MakeInParam("@digger", (DbType)NpgsqlDbType.Char, 20,userInfo.Username)                                        
                                  };
        ...
        public IDataReader GetDebatePostList(int tid, int opinion, int pageSize, int pageIndex, string postTableId, PostOrderType postOrderType)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                        DbHelper.MakeInParam("@opinion", (DbType)NpgsqlDbType.Integer, 4, opinion),
                                        DbHelper.MakeInParam("@pagesize", (DbType)NpgsqlDbType.Integer, 4, pageSize),
                                        DbHelper.MakeInParam("@pageindex", (DbType)NpgsqlDbType.Integer, 4, pageIndex)
                                  };
        ...
        public IDataReader GetUserDiggs(int tid, int uid)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                        DbHelper.MakeInParam("@diggerid", (DbType)NpgsqlDbType.Integer, 4, uid)
        ...
        public int ReviseDebateTopicDiggs(int tid, int debateOpinion)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 4, tid),
                                        DbHelper.MakeInParam("@opinion", (DbType)NpgsqlDbType.Integer, 4, debateOpinion),
                                        DbHelper.MakeOutParam("@count", (DbType)NpgsqlDbType.Integer, 4)
                                  };
        ...
        {
            string commandText = string.Format("INSERT INTO [{0}postid] ([postdatetime]) VALUES(NOW());SELECT SCOPE_IDENTITY()",
                                                            BaseConfigs.GetTablePrefix);
        ...
        public IDataReader GetAttentionTopics(string fidList, int tpp, int pageIndex, string keyWord)
        {
            ...
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Varchar, 255, fidList),
                                        DbHelper.MakeInParam("@tpp", (DbType)NpgsqlDbType.Integer, 4, tpp),
                                        DbHelper.MakeInParam("@pageid", (DbType)NpgsqlDbType.Integer, 4, pageIndex),
                                        DbHelper.MakeInParam("@condition", (DbType)NpgsqlDbType.Varchar, 255, condition)                                        
                                  };
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@attention", (DbType)NpgsqlDbType.Integer, 4, attention),
                                        DbHelper.MakeInParam("@datetime", (DbType)NpgsqlDbType.Timestamp, 8, dateTime)
                                  };
        ...
        public IDataReader GetNoUsedAttachmentListByUid(int userId, string posttime, int isimage)
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,userId),
                                    DbHelper.MakeInParam("@posttime",(DbType)NpgsqlDbType.Timestamp,8,DBNull.Value),
                                    DbHelper.MakeInParam("@isimage",(DbType)NpgsqlDbType.Smallint,1,isimage)
                                  };
            if (posttime != "")
            ...
            if (posttime == null)
            {
                ...
                {
                    sb.Append("	SELECT [aid], [uid], [tid], [pid], [postdatetime], [readperm], [filename], [description], [filetype], [filesize], [attachment], [downloads], [width], [height], [attachprice],[isimage]		FROM [dnt_attachments]  WHERE [uid] = @uid AND [pid]=0 AND [tid]=0 AND [isimage]=@isimage ORDER BY [aid] ASC");
                }
                else
                {
                    sb.Append("SELECT [aid], [uid], [tid], [pid], [postdatetime], [readperm], [filename], [description], [filetype], [filesize], [attachment], [downloads], [width], [height], [attachprice],[isimage]		FROM [dnt_attachments]   WHERE [uid] = @uid AND [pid]=0 AND [tid]=0 ORDER BY [aid] ASC");
                }
            }
            else
            {
                if (isimage == 0 || isimage == 1)
                {
                    sb.Append("SELECT [aid], [uid], [tid], [pid], [postdatetime], [readperm], [filename], [description], [filetype], [filesize], [attachment], [downloads], [width], [height], [attachprice],[isimage]		FROM [dnt_attachments]   WHERE [uid] = @uid AND [postdatetime]>@posttime AND [pid]=0 AND [tid]=0 AND [isimage]=@isimage ORDER BY [aid] ASC");
                }
                else
                    sb.Append("		SELECT [aid], [uid], [tid], [pid], [postdatetime], [readperm], [filename], [description], [filetype], [filesize], [attachment], [downloads], [width], [height], [attachprice],[isimage]		FROM [dnt_attachments]   WHERE [uid] = @uid AND [postdatetime]>@posttime AND [pid]=0 AND [tid]=0 ORDER BY [aid] ASC");
            }
            return DbHelper.ExecuteReader(CommandType.Text,
                                          sb.ToString(), parms);
        }
        ...
        public IDataReader GetEditPostAttachList(int userid, string aidList)
        {
            DbParameter[] parms = {
                                    DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,userid),
                                    DbHelper.MakeInParam("@aidlist",(DbType)NpgsqlDbType.Varchar,2000,aidList),
                                  };
            return DbHelper.ExecuteReader(CommandType.StoredProcedure,
        ...
        {
            DbParameter[] parms = {
                                     DbHelper.MakeInParam("@attachidlist",(DbType)NpgsqlDbType.Varchar,2000,attachIdList),
                                     DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,uid)
                                  };
        ...
        public IDataReader GetUserPostCountList(int topNumber, DateType dateType, int dateNum, string postTableName)
        {
            ...
            string commandText = string.Format("SELECT TOP {0} [posterid] As [uid], [poster] As [username], COUNT(pid) AS [postcount] FROM  [{1}] WHERE [posterid] > 0 AND [invisible] <=0 AND DATEDIFF({2}, [postdatetime], NOW()) <= {3} GROUP BY [posterid], [poster] ORDER BY [postcount] DESC",
                                        topNumber,
                                        postTableName,
                                        dateTypeStr,
                                        dateNum);
