...
namespace Discuz.Data.PostgreSQL
{
    public partial class DataProvider : IDataProvider
    {
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@now", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Now);
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@poster", (DbType)NpgsqlDbType.Varchar, 20, announcementInfo.Poster),
                                        DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Integer, 4, announcementInfo.Posterid),
                                        DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Varchar, 250, announcementInfo.Title),
                                        DbHelper.MakeInParam("@displayorder", (DbType)NpgsqlDbType.Integer, 4, announcementInfo.Displayorder),
                                        DbHelper.MakeInParam("@starttime", (DbType)NpgsqlDbType.Timestamp, 8, announcementInfo.Starttime),
                                        DbHelper.MakeInParam("@endtime", (DbType)NpgsqlDbType.Timestamp, 8, announcementInfo.Endtime),
                                        DbHelper.MakeInParam("@message", (DbType)NpgsqlDbType.Text, 0, announcementInfo.Message)
                                    };
        ...
        {
            DbParameter param = DbHelper.MakeInParam("@id", (DbType)NpgsqlDbType.Integer, 4, id);
        ...
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@id", (DbType)NpgsqlDbType.Integer, 4, announcementInfo.Id),
                                        DbHelper.MakeInParam("@poster", (DbType)NpgsqlDbType.Varchar, 20, announcementInfo.Poster),
                                        DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Varchar, 250, announcementInfo.Title),
                                        DbHelper.MakeInParam("@displayorder", (DbType)NpgsqlDbType.Integer, 4, announcementInfo.Displayorder),
                                        DbHelper.MakeInParam("@starttime", (DbType)NpgsqlDbType.Timestamp, 8, announcementInfo.Starttime),
        ...
        public int AddCreditsLog(int uid, int fromTo, int sendCredits, int receiveCredits, float send, float receive, string payDate, int operation)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@fromto",(DbType)NpgsqlDbType.Integer,4,fromTo),
									   DbHelper.MakeInParam("@sendcredits",(DbType)NpgsqlDbType.Integer,4,sendCredits),
									   DbHelper.MakeInParam("@receivecredits",(DbType)NpgsqlDbType.Integer,4,receiveCredits),
									   DbHelper.MakeInParam("@send",(DbType)NpgsqlDbType.Real,4,send),
									   DbHelper.MakeInParam("@receive",(DbType)NpgsqlDbType.Numeric,4,receive),    //使用Float会造成小数点后位数过长，导致显示不友好。所以在此使用Decimal
									   DbHelper.MakeInParam("@paydate",(DbType)NpgsqlDbType.Varchar,0,payDate),
									   DbHelper.MakeInParam("@operation",(DbType)NpgsqlDbType.Integer,4,operation)
								   };
        ...
        public void ShrinkDataBase(string shrinkSize, string dbName)
        {
            ...
            sqlBuilder.Append("SELECT @StartTime = NOW(), ");
            ...
            sqlBuilder.Append("WHILE @MaxMinutes > DATEDIFF (mi, @StartTime, NOW()) -- time has not expired ");
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@DBName", (DbType)NpgsqlDbType.Varchar, 50, dbName),
			};
        ...
        public bool CreateORFillIndex(string dbName, string postsId)
        {
            ...
            try
            {
                string commandText = string.Format("SELECT  [pid] FROM [{0}] WHERE CONTAINS([message],'asd') ORDER BY [pid] ASC limit 1", currenttablename);
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@lastuserid", (DbType)NpgsqlDbType.Integer, 4, lastUserId),
        ...
        public void AddVisitLog(int uid, string userName, int groupId, string groupTitle, string ip, string actions, string others)
        {
            DbParameter[] parms = {
					...
					DbHelper.MakeInParam("@grouptitle", (DbType)NpgsqlDbType.Varchar, 50, groupTitle),
					...
					DbHelper.MakeInParam("@others", (DbType)NpgsqlDbType.Varchar, 200, others)
				};
        ...
        public void AddTemplate(string name, string directory, string copyRight, string author, string createDate, string ver, string forDntVer)
        {
            DbParameter[] parms = { 
                                        ...
                                        DbHelper.MakeInParam("@directory", (DbType)NpgsqlDbType.Varchar, 100, directory),
                                        DbHelper.MakeInParam("@copyright", (DbType)NpgsqlDbType.Varchar, 100, copyRight),
                                        DbHelper.MakeInParam("@author", (DbType)NpgsqlDbType.Varchar, 100, author),
                                        DbHelper.MakeInParam("@createdate", (DbType)NpgsqlDbType.Varchar, 50, createDate),
                                        DbHelper.MakeInParam("@ver", (DbType)NpgsqlDbType.Varchar, 100, ver),
                                        DbHelper.MakeInParam("@fordntver", (DbType)NpgsqlDbType.Varchar, 100, forDntVer)
                                    };
        ...
        {
            DbParameter[] parms = {
				DbHelper.MakeInParam("@templatename", (DbType)NpgsqlDbType.Varchar, 0, templateName),
				DbHelper.MakeInParam("@directory", (DbType)NpgsqlDbType.Varchar, 0, directory),
				DbHelper.MakeInParam("@copyright", (DbType)NpgsqlDbType.Varchar, 0, copyRight)
			};
        ...
        public bool InsertModeratorLog(string moderatorUid, string moderatorName, string groupId, string groupTitle, string ip, string postDateTime, string fid, string fname, string tid, string title, string actions, string reason)
        {
            ...
            {
                DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@moderatoruid", (DbType)NpgsqlDbType.Integer, 4, moderatorUid),
                                        DbHelper.MakeInParam("@moderatorname", (DbType)NpgsqlDbType.Varchar, 50, moderatorName),
                                        DbHelper.MakeInParam("@groupid", (DbType)NpgsqlDbType.Integer, 4, groupId),
                                        DbHelper.MakeInParam("@grouptitle", (DbType)NpgsqlDbType.Varchar, 50, groupTitle),
                                        DbHelper.MakeInParam("@ip", (DbType)NpgsqlDbType.Varchar, 15, ip),
                                        DbHelper.MakeInParam("@postdatetime", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(postDateTime)),
                                        DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Integer, 4, fid),
                                        DbHelper.MakeInParam("@fname", (DbType)NpgsqlDbType.Varchar, 100, fname),
                                        DbHelper.MakeInParam("@tid", (DbType)NpgsqlDbType.Integer, 8, tid),
                                        DbHelper.MakeInParam("@title", (DbType)NpgsqlDbType.Varchar, 200, title),
                                        DbHelper.MakeInParam("@actions", (DbType)NpgsqlDbType.Varchar, 50, actions),
                                        DbHelper.MakeInParam("@reason", (DbType)NpgsqlDbType.Varchar, 200, reason)
                                    };
        ...
        public DataTable GetErrLoginRecordByIP(string ip)
        {
            ...
            string commandText = string.Format("SELECT   [errcount], [lastupdate] FROM [{0}failedlogins] WHERE [ip]=@ip limit 1", BaseConfigs.GetTablePrefix);
        ...
        public int AddErrLoginCount(string ip)
        {
            ...
            string commandText = string.Format("UPDATE [{0}failedlogins] SET [errcount]=[errcount]+1, [lastupdate]=NOW() WHERE [ip]=@ip",
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public int AddErrLoginRecord(string ip)
        {
            ...
            string commandText = string.Format("DELETE FROM [{0}failedlogins] WHERE [ip]=@ip;INSERT INTO [{0}failedlogins] ([ip], [errcount], [lastupdate]) VALUES(@ip, 1, NOW())",
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public int ResetErrLoginCount(string ip)
        {
            ...
            string commandText = string.Format("UPDATE [{0}failedlogins] SET [errcount]=1, [lastupdate]=NOW() WHERE [ip]=@ip",
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public int DeleteErrLoginRecord(string ip)
        {
            ...
            string commandText = string.Format("DELETE FROM [{0}failedlogins] WHERE [ip]=@ip OR EXTRACT(minute from ( NOW()-[lastupdate])) > 15",
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public int UpdateDetachTable(int fid, string description)
        {
            DbParameter[] parms = {
                                        DbHelper.MakeInParam("@fid", (DbType)NpgsqlDbType.Integer, 4, fid),
                                        DbHelper.MakeInParam("@description", (DbType)NpgsqlDbType.Varchar, 50, description)
                                    };
        ...
        public void AddPostTableToTableList(string description, int mintid, int maxtid)
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@description", (DbType)NpgsqlDbType.Varchar, 50, description),
                                        DbHelper.MakeInParam("@mintid", (DbType)NpgsqlDbType.Integer, 4, mintid),
                                        DbHelper.MakeInParam("@maxtid", (DbType)NpgsqlDbType.Integer, 4, maxtid)
                                    };
        ...
        {
            string commandText = string.Format("SELECT   [rows] FROM [sysindexes] WHERE [name]='PK_{0}posts{1}' limit 1",
                                                BaseConfigs.GetTablePrefix,
                                                postsId);
            return DbHelper.ExecuteDataset(CommandType.Text, commandText).Tables[0];
        }
        ...
        {
            string commandText = string.Format("SELECT  [pid] FROM [{0}posts{1}] WHERE CONTAINS([message],'asd') ORDER BY [pid] ASC  limit 1",
                                                BaseConfigs.GetTablePrefix,
                                                postTableId);
            DbHelper.ExecuteNonQuery(CommandType.Text, commandText);
        }
        ...
        {
            string commandText = string.Format("SELECT COALESCE(MAX([id]), 0) FROM [{0}tablelist]", BaseConfigs.GetTablePrefix);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text, commandText));
        }

        public int GetMaxPostTableTid(string postTableName)
        {
            string commandText = string.Format("SELECT COALESCE(MAX([tid]), 0) FROM [{0}]", postTableName);
        ...
        {
            string commandText = string.Format("SELECT COALESCE(MIN([tid]), 0) FROM [{0}]", postTableName);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text, commandText)) + 1;
        }
        ...
        public void AddAdInfo(int available, string type, int displayOrder, string title, string targets, string parameters, string code, string startTime, string endTime)
        {
            DbParameter[] parms = { 
                                        ...
                                        DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Varchar, 50, type),
                                        ...
                                        DbHelper.MakeInParam("@targets", (DbType)NpgsqlDbType.Varchar, 255, targets),
                                        DbHelper.MakeInParam("@parameters", (DbType)NpgsqlDbType.Text, 0, parameters),
                                        DbHelper.MakeInParam("@code", (DbType)NpgsqlDbType.Text, 0, code),
                                        DbHelper.MakeInParam("@starttime", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(startTime)),
                                        DbHelper.MakeInParam("@endtime", (DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(endTime))                                        
                                    };
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Integer, 4, type)
        ...
        public void BuyTopic(int uid, int tid, int posterId, int price, float netAmount, int creditsTrans)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@authorid",(DbType)NpgsqlDbType.Integer,4,posterId),
									   DbHelper.MakeInParam("@buydate",(DbType)NpgsqlDbType.Timestamp,4,DateTime.Now),
									   DbHelper.MakeInParam("@amount",(DbType)NpgsqlDbType.Integer,4,price),
									   DbHelper.MakeInParam("@netamount",(DbType)NpgsqlDbType.Real,8,netAmount)
								   };
        ...
        public void AddSmiles(int id, int displayOrder, int type, string code, string url)
        {
            DbParameter[] parms = {
                                        ...
                                        DbHelper.MakeInParam("@displayorder", (DbType)NpgsqlDbType.Integer, 4, displayOrder),
                                        DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Integer, 4, type),
                                        DbHelper.MakeInParam("@code", (DbType)NpgsqlDbType.Varchar, 30, code),
                                        DbHelper.MakeInParam("@url", (DbType)NpgsqlDbType.Varchar, 60, url)
                                    };
        ...
        {
            string commandText = string.Format("SELECT COALESCE(MAX(id), 0) FROM [{0}smilies]", BaseConfigs.GetTablePrefix);
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text, commandText)) + 1;
        }
        ...
        {
            string commandText = string.Format("SELECT  {0} FROM [{1}statistics] LIMIT 1", DbFields.STATISTICS, BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteDatasetInMasterDB(CommandType.Text, commandText).Tables[0];
        }
        ...
        {
            string commandText = string.Format("SELECT SUM([topics]) AS [topiccount],SUM([posts]) AS [postcount],SUM([todayposts])-(SELECT SUM([todayposts]) FROM [{0}forums] WHERE [lastpost] < CONVERT(CHAR(12),NOW(),101) AND [layer]=1) AS [todaypostcount] FROM [{0}forums] WHERE [layer]=1",
                                                BaseConfigs.GetTablePrefix);
        ...
        {
            string commandText = string.Format("SELECT SUM([topics]) AS [topiccount],SUM([posts]) AS [postcount],SUM([todayposts])-(SELECT SUM([todayposts]) FROM [{0}forums] WHERE [lastpost] < CONVERT(CHAR(12),NOW(),101) AND [layer]=1 AND [fid] = @fid) AS [todaypostcount] FROM [{0}forums] WHERE [fid] = {1} AND [layer]=1",
                                                BaseConfigs.GetTablePrefix,
                                                fid);
            return DbHelper.ExecuteReader(CommandType.Text, commandText);
        }
        ...
        {
            string commandText = string.Format("SELECT   {0} FROM [{1}] WHERE [pid]={2} limit 1",
                                                DbFields.POSTS,
                                                postTableName,
                                                pid);
            return DbHelper.ExecuteDataset(CommandType.Text, commandText).Tables[0];
        ...
        {
            string commandText = string.Format("SELECT  {0} FROM [{1}] WHERE [layer]=0  AND [tid]={2} limit 1",
                                                DbFields.POSTS,
                                                postTableName,
                                                tid);
            return DbHelper.ExecuteDataset(CommandType.Text, commandText).Tables[0];
        ...
        public int Search(bool spaceEnabled, bool albumEnabled, int postTableId, int userId, int userGroupId, string keyWord, int posterId, SearchType searchType, string searchForumId, int searchTime, int searchTimeType, int resultOrder, int resultOrderType)
        {
            ...
            DbParameter[] prams2 = {
										DbHelper.MakeInParam("@searchstring",(DbType)NpgsqlDbType.Varchar,255, sql),
										DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer,4,userId),
										DbHelper.MakeInParam("@groupid",(DbType)NpgsqlDbType.Integer,4,userGroupId)
									};
        ...
        {
            DbParameter parm = DbHelper.MakeInParam("@topicid", (DbType)NpgsqlDbType.Integer, 4, topicId);
        ...
        {
            DbParameter[] parms = {
                DbHelper.MakeInParam("@key", (DbType)NpgsqlDbType.Varchar, 100, key),
                DbHelper.MakeInParam("@servername", (DbType)NpgsqlDbType.Varchar, 100, serverName),
                DbHelper.MakeInParam("@lastexecuted", (DbType)NpgsqlDbType.Timestamp, 8, lastExecuted)
            };
        ...
        public DateTime GetLastExecuteScheduledEventDateTime(string key, string serverName)
        {
            DbParameter[] parms = {
                DbHelper.MakeInParam("@key", (DbType)NpgsqlDbType.Varchar, 100, key),
                DbHelper.MakeInParam("@servername", (DbType)NpgsqlDbType.Varchar, 100, serverName),
                DbHelper.MakeOutParam("@lastexecuted", (DbType)NpgsqlDbType.Timestamp, 8)
            };
        ...
        {
            DbParameter[] parms = {
                DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Char, 10, type),
                DbHelper.MakeInParam("@variable", (DbType)NpgsqlDbType.Char, 20, variable),
        ...
        {
            DbParameter[] parms = {
                DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Char, 20, type),
                DbHelper.MakeInParam("@variable", (DbType)NpgsqlDbType.Char, 20, variable),
                DbHelper.MakeInParam("@value", (DbType)NpgsqlDbType.Text, 0, value)
            };
        ...
        public IDataReader GetBestMember(string postTableId)
        {
            ...
            string commandText = string.Format("SELECT  [poster], COUNT(1) AS [posts] FROM [{0}posts{1}] WHERE [postdatetime]>='{2}' AND [invisible]=0 AND [posterid]>0 GROUP BY [poster] ORDER BY [posts] DESC limit 1",
                                                BaseConfigs.GetTablePrefix,
                                                postTableId,
                                                DateTime.Now.ToString("yyyy-MM-dd"));
            return DbHelper.ExecuteReader(CommandType.Text, commandText);
        ...
        {
            string commandText = string.Format("SELECT  [fid], [name], [topics] FROM [{1}forums] WHERE [status]>0 AND [layer]>0 ORDER BY [topics] DESC limit {0}",
                                                count,
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteReader(CommandType.Text, commandText);
        }
        ...
        {
            string commandText = string.Format("SELECT   [fid], [name], [posts] FROM [{1}forums] WHERE [status]>0 AND [layer]>0 ORDER BY [posts] DESC limit {0}",
                                                count,
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteReader(CommandType.Text, commandText);
        }
        ...
        public IDataReader GetForumsByMonthPostCount(int count, string postTableId)
        {
            ...
            string commandText = string.Format("SELECT DISTINCT   [p].[fid], [f].[name], COUNT([pid]) AS [posts] FROM [{1}posts{2}] [p] LEFT JOIN [{1}forums] [f] ON [p].[fid]=[f].[fid] WHERE [postdatetime]>='{3}' AND [invisible]=0 AND [posterid]>0 GROUP BY [p].[fid], [f].[name] ORDER BY [posts] DESC limit {0}",
                                                count,
                                                BaseConfigs.GetTablePrefix,
                                                postTableId,
                                                DateTime.Now.AddDays(-30).ToString("yyyy-MM-dd"));
        ...
        public IDataReader GetUsersRank(int count, string postTableId, string type)
        {
            ...
            {
                case "posts":
                    commandText = string.Format("SELECT   [username], [uid], [posts] FROM [{1}users] WHERE [posts]>0 ORDER BY [posts] DESC, [uid] LIMIT {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "digestposts":
                    commandText = string.Format("SELECT   [username], [uid], [digestposts] FROM [{1}users] WHERE [digestposts]>0 ORDER BY [digestposts] DESC, [uid] LIMIT {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "thismonth":
                    commandText = string.Format("SELECT DISTINCT  [poster] AS [username], [posterid] AS [uid], COUNT(pid) AS [posts] FROM [{1}posts{2}] WHERE [postdatetime]>='{3}' AND [invisible]=0 AND [posterid]>0 GROUP BY [poster], [posterid] ORDER BY [posts] DESC  LIMIT {0}", count, BaseConfigs.GetTablePrefix, postTableId, DateTime.Now.AddDays(-30).ToString("yyyy-MM-dd"));
                    break;
                case "thisweek":
                    commandText = string.Format("SELECT DISTINCT   [poster] AS [username], [posterid] AS [uid], COUNT(pid) AS [posts] FROM [{1}posts{2}] WHERE [postdatetime]>='{3}' AND [invisible]=0 AND [posterid]>0 GROUP BY [poster], [posterid] ORDER BY [posts] DESC LIMIT {0}", count, BaseConfigs.GetTablePrefix, postTableId, DateTime.Now.AddDays(-7).ToString("yyyy-MM-dd"));
                    break;
                case "today":
                    commandText = string.Format("SELECT DISTINCT  [poster] AS [username], [posterid] AS [uid], COUNT(pid) AS [posts] FROM [{1}posts{2}] WHERE [postdatetime]>='{3}' AND [invisible]=0 AND [posterid]>0 GROUP BY [poster], [posterid] ORDER BY [posts] DESC limit {0}", count, BaseConfigs.GetTablePrefix, postTableId, DateTime.Now.ToString("yyyy-MM-dd"));
                    break;
                case "credits":
                    commandText = string.Format("SELECT   [username], [uid], [credits] FROM [{1}users] ORDER BY [credits] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits1":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits1] FROM [{1}users] ORDER BY [extcredits1] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits2":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits2] FROM [{1}users] ORDER BY [extcredits2] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits3":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits3] FROM [{1}users] ORDER BY [extcredits3] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits4":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits4] FROM [{1}users] ORDER BY [extcredits4] DESC, [uid] limit{0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits5":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits5] FROM [{1}users] ORDER BY [extcredits5] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits6":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits6] FROM [{1}users] ORDER BY [extcredits6] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits7":
                    commandText = string.Format("SELECT  [username], [uid], [extcredits7] FROM [{1}users] ORDER BY [extcredits7] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                case "extcredits8":
                    commandText = string.Format("SELECT   [username], [uid], [extcredits8] FROM [{1}users] ORDER BY [extcredits8] DESC, [uid] limit {0}", count, BaseConfigs.GetTablePrefix);
                    break;
                //case "oltime":
        ...
        public IDataReader GetNoticeByUid(int uid, NoticeType noticeType)
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, uid),
                                        DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Integer, 4, noticeType),
                                  };
        ...
        public IDataReader GetNewNotices(int userId)
        {
            string commandText = string.Format("SELECT Top 5 [nid], [uid], [type], [new], [posterid], [poster], [note], [postdatetime]  FROM [{0}notices] WHERE [uid] = @uid AND [new] = 1 ORDER BY [postdatetime] DESC",
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteReader(CommandType.Text, commandText, DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, userId));
        }
        ...
        public IDataReader GetNoticeByNid(int noticeId)
        {
            string commandText = string.Format("SELECT [nid], [uid], [type], [new], [posterid], [poster], [note], [postdatetime]  FROM [{0}notices] WHERE [nid] = @nid ORDER BY [postdatetime] DESC",
                                                BaseConfigs.GetTablePrefix);
            return DbHelper.ExecuteReader(CommandType.Text, commandText,
                                          DbHelper.MakeInParam("@nid", (DbType)NpgsqlDbType.Integer, 4, noticeId));
        }
        ...
        public int GetNoticeCountByUid(int uid, NoticeType noticeType)
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, uid),
                                        DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Integer, 4, (int)noticeType)
                                  };
        ...
        public int GetNewNoticeCountByUid(int uid)
        {
            ...
            return TypeConverter.ObjectToInt(DbHelper.ExecuteScalar(CommandType.Text,
                                                                    string.Format("SELECT COUNT(nid) FROM [{0}notices] WHERE [uid] =  @uid  AND [new] = 1", BaseConfigs.GetTablePrefix),
                                                                    parms));
        }
        ...
        {
            DbParameter[] parms = { 
                                        DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.Uid),
                                        DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.Type),
                                        DbHelper.MakeInParam("@new", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.New),
        ...
        //{
        //    DbParameter[] parms = { 
        //                                DbHelper.MakeInParam("@nid", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.Nid),
        //                                DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.Uid),
        //                                DbHelper.MakeInParam("@type", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.Type),
        //                                DbHelper.MakeInParam("@new", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.New),
        //                                DbHelper.MakeInParam("@posterid", (DbType)NpgsqlDbType.Integer, 4, noticeInfo.Posterid),
        ...
        public bool DeleteNoticeByNid(int nid)
        {
            ...
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText,
                                            DbHelper.MakeInParam("@nid", (DbType)NpgsqlDbType.Integer, 4, nid)) > 0;
        }
        ...
        public bool DeleteNoticeByUid(int uid)
        {
            ...
            return DbHelper.ExecuteNonQuery(CommandType.Text, commandText,
                                            DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, uid)) > 0;
        }
        ...
        {
            DbParameter[] parms = {                                    
                                    DbHelper.MakeInParam("@new", (DbType)NpgsqlDbType.Integer, 4, newType),
                                    DbHelper.MakeInParam("@uid", (DbType)NpgsqlDbType.Integer, 4, uid)
                                };
        ...
        public void DeleteNotice(NoticeType noticeType, int days)
        {
            ...
            {
                commandText = string.Format("DELETE FROM [{0}notices] WHERE DATEDIFF(d,[postdatetime], NOW()) > {1}",
                                             BaseConfigs.GetTablePrefix,
                                             days);
                DbHelper.ExecuteNonQuery(CommandType.Text, commandText);
            }
            ...
            {
                commandText = string.Format("DELETE FROM [{0}notices] WHERE [type] = {1}  AND DATEDIFF(d,[postdatetime], NOW()) > {2}",
                                             BaseConfigs.GetTablePrefix,
                                             (int)noticeType, days);
                DbHelper.ExecuteNonQuery(CommandType.Text, commandText);
            }
        ...
        public void AddBannedIp(IpInfo info)
        {
            DbParameter[] parameters = {
                                         DbHelper.MakeInParam("@ip1",(DbType)NpgsqlDbType.Integer, 4, info.Ip1),
                                         DbHelper.MakeInParam("@ip2",(DbType)NpgsqlDbType.Integer, 4, info.Ip2),
                                         DbHelper.MakeInParam("@ip3",(DbType)NpgsqlDbType.Integer, 4, info.Ip3),
                                         DbHelper.MakeInParam("@ip4",(DbType)NpgsqlDbType.Integer, 4, info.Ip4),
                                         DbHelper.MakeInParam("@admin",(DbType)NpgsqlDbType.Varchar,50,info.Username),
                                         DbHelper.MakeInParam("@dateline",(DbType)NpgsqlDbType.Varchar,50,info.Dateline),
                                         DbHelper.MakeInParam("@expiration",(DbType)NpgsqlDbType.Varchar,50,info.Expiration)
                                       };
        ...
        public int UpdateBanIpExpiration(int id, string endTime)
        {
            DbParameter[] parameters = {
                                         DbHelper.MakeInParam("@id",(DbType)NpgsqlDbType.Integer, 4, id),
                                         DbHelper.MakeInParam("@expiration",(DbType)NpgsqlDbType.Timestamp, 8, DateTime.Parse(endTime)),
                                       };
        ...
        {
            DbParameter[] param = {
                                         DbHelper.MakeInParam("@parentid",(DbType)NpgsqlDbType.Integer,4,nav.Parentid),
                                         DbHelper.MakeInParam("@name",(DbType)NpgsqlDbType.Char, 50, nav.Name),
                                         DbHelper.MakeInParam("@title",(DbType)NpgsqlDbType.Char, 255, nav.Title),
                                         DbHelper.MakeInParam("@url",(DbType)NpgsqlDbType.Char, 255, nav.Url),
                                         DbHelper.MakeInParam("@target",(DbType)NpgsqlDbType.Smallint, 1, nav.Target),
                                         DbHelper.MakeInParam("@available",(DbType)NpgsqlDbType.Smallint,1,nav.Available),
                                         DbHelper.MakeInParam("@displayorder",(DbType)NpgsqlDbType.Smallint,2,nav.Displayorder),
                                         DbHelper.MakeInParam("@level",(DbType)NpgsqlDbType.Smallint,1,nav.Level)
                                       };
        ...
        public void UpdateNavigation(NavInfo nav)
        {
            DbParameter[] param = {
                                         ...
                                         DbHelper.MakeInParam("@displayorder",(DbType)NpgsqlDbType.Smallint,2,nav.Displayorder),
                                         DbHelper.MakeInParam("@level",(DbType)NpgsqlDbType.Smallint,1,nav.Level),
                                         DbHelper.MakeInParam("@id",(DbType)NpgsqlDbType.Integer,4,nav.Id)
                                       };
        ...
        public int GetNoticeCount(int userId, int state)
        {
            DbParameter[] parms = {
									   ...
									   DbHelper.MakeInParam("@type",(DbType)NpgsqlDbType.Integer,4, -1),
        ...
        public int ReNewNotice(int type, int uid)
        {
            DbParameter[] parms = {
						   DbHelper.MakeInParam("@type",(DbType)NpgsqlDbType.Integer, 4, type),
                           DbHelper.MakeInParam("@date",(DbType)NpgsqlDbType.Timestamp, 4, DateTime.Now),
						   DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer, 4, uid)
					   };
        ...
        {
            DbParameter[] parms = {
						   DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Uid),
                           DbHelper.MakeInParam("@username",(DbType)NpgsqlDbType.Char, 20, attachPaymentLogInfo.UserName),
                           DbHelper.MakeInParam("@postdatetime",(DbType)NpgsqlDbType.Timestamp, 8, attachPaymentLogInfo.PostDateTime),
                           DbHelper.MakeInParam("@amount",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Amount),
                           DbHelper.MakeInParam("@netamount",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.NetAmount),
                           DbHelper.MakeInParam("@aid",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Aid),
						   DbHelper.MakeInParam("@authorid",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Authorid)
					   };
        ...
        {
            DbParameter[] parms = {
                           DbHelper.MakeInParam("@id",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Id),
						   DbHelper.MakeInParam("@uid",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Uid),
                           DbHelper.MakeInParam("@username",(DbType)NpgsqlDbType.Char, 20, attachPaymentLogInfo.UserName),
                           DbHelper.MakeInParam("@postdatetime",(DbType)NpgsqlDbType.Timestamp, 8, attachPaymentLogInfo.PostDateTime),
                           DbHelper.MakeInParam("@amount",(DbType)NpgsqlDbType.Integer, 4, attachPaymentLogInfo.Amount),
